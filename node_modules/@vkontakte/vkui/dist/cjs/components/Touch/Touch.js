...
var Touch = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2.default)(Touch, _React$Component);

  var _super = (0, _createSuper2.default)(Touch);
  ...
  function Touch() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onStart", function (e) {
      ...
      var outputEvent = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, _this.gesture), {}, {
        originalEvent: e
      });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onMove", function (e) {
      ...
      if (isPressed) {
        ...
        if (_this.gesture.isSlide) {
          ...
          var _outputEvent = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, _this.gesture), {}, {
            originalEvent: e
          });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onEnd", function (e) {
      ...
      if (isPressed) {
        // Вызываем нужные колбеки из props
        var _outputEvent2 = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, _this.gesture), {}, {
          originalEvent: e
        });
